    ...
    public static function migrate(): void
    {
        ...
        $schemas = [
            ...
            "CREATE TABLE {$user_accounts} (
                ...
                UNIQUE KEY application_login (application_id, login_id),
            ...
            "CREATE TABLE {$capabilities} (
                ...
                UNIQUE KEY application_capability (application_id, capability),
                KEY application_id (application_id)
            ) {$charset_collate};",
            "CREATE TABLE {$user_capabilities} (
                user_capability_id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
                application_id bigint(20) unsigned NOT NULL,
                user_account_id bigint(20) unsigned NOT NULL,
                capability_id bigint(20) unsigned NOT NULL,
                created_at datetime NOT NULL,
                PRIMARY KEY (user_capability_id),
                UNIQUE KEY user_capability (application_id, user_account_id, capability_id),
                KEY application_id (application_id),
                KEY user_account_id (user_account_id),
